...
class DependencyDashboard extends Widget {
    constructor(props) {
        ...
        this.tableRows = {
            ...
            nextVersion: 'Number of dependencies where the next version available is smaller than an incremental version update	',
            nextIncremental: 'Number of dependencies where the next version available is an incremental version update',
        ...
        return (
            <div className='main'>
                <MuiThemeProvider
                    ...
                    <h1 style={{ 'text-align': 'center' }}>Dependency Summery Dashboard</h1>
                    ...
                    <Paper className='table'>
                        <Table >
                            ...
                            <TableBody>
                                {tableRowList}
                                {/* <TableCell numeric>{this.state.usingLatestVersion ? this.state.usingLatestVersion : 0}</TableCell>
                                <TableCell numeric>{this.state.nextIncremental ? this.state.nextIncremental : 0}</TableCell>
                                <TableCell numeric>{this.state.nextVersion ? this.state.nextVersion : 0}</TableCell>
                                <TableCell numeric>{this.state.nextMinor ? this.state.nextMinor : 0}</TableCell>
                                <TableCell numeric>{this.state.nextMajor ? this.state.nextMajor : 0}</TableCell> */}
                            </TableBody>
                        </Table>
                    </Paper>
                </MuiThemeProvider>
